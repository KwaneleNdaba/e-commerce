...
export const CustomHero: React.FC<Page['hero']> = ({ richText, media, links }) => {
  ...
  //we want to get the link of the image from the page and make it a background image
  //if the media is not a string we want to get access to the media hosted for us by payload
